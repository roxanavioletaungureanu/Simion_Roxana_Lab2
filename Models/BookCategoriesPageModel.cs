...
namespace Simion_Roxana_Lab2.Models
{
    public class BookCategoriesPageModel: PageModel
    {
        public List<AssignedCategoryData> AssignedCategoryDataList;
        public void PopulateAssignedCategoryData(Simion_Roxana_Lab2Context context,
        Book book)
        {
        ...
        public void UpdateBookCategories(Simion_Roxana_Lab2Context context,
